#ifndef __GridDemonstraor_ADERDG_CLASS_HEADER__
#define __GridDemonstraor_ADERDG_CLASS_HEADER__
...
#include "AbstractGridDemonstraor_ADERDG.h"
...
namespace GridDemonstrator{
  class GridDemonstraor_ADERDG;
}

class GridDemonstrator::GridDemonstraor_ADERDG : public GridDemonstrator::AbstractGridDemonstraor_ADERDG {
  private:
    /**
     * Log device
     */
  ...
  public:
    GridDemonstraor_ADERDG(double maximumMeshSize,int maximumAdaptiveMeshDepth,int DMPObservables,int limiterHelperLayers,exahype::solvers::Solver::TimeStepping timeStepping,std::vector<std::string>& cmdlineargs);
...
#endif // __GridDemonstraor_ADERDG_CLASS_HEADER__
