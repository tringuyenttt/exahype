#ifndef __GridDemonstrator_ADERDG_CLASS_HEADER__
#define __GridDemonstrator_ADERDG_CLASS_HEADER__
...
#include "AbstractGridDemonstrator_ADERDG.h"
...
namespace GridDemonstrator{
  class GridDemonstrator_ADERDG;
}

class GridDemonstrator::GridDemonstrator_ADERDG : public GridDemonstrator::AbstractGridDemonstrator_ADERDG {
  private:
    /**
     * Log device
     */
  ...
  public:
    GridDemonstrator_ADERDG(double maximumMeshSize,int maximumAdaptiveMeshDepth,int DMPObservables,int limiterHelperLayers,exahype::solvers::Solver::TimeStepping timeStepping,std::vector<std::string>& cmdlineargs);
...
#endif // __GridDemonstrator_ADERDG_CLASS_HEADER__
