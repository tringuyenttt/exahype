#ifndef __GRMHDSolver_FV_CLASS_HEADER__
#define __GRMHDSolver_FV_CLASS_HEADER__
...
class GRMHD::GRMHDSolver_FV : public GRMHD::AbstractGRMHDSolver_FV {
  private:
    /**
     * Log device
     */
...
#endif // __GRMHDSolver_FV_CLASS_HEADER__
