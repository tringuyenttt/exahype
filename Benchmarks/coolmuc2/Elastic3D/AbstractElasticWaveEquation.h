#ifndef __AbstractElasticWaveEquation_CLASS_HEADER__
#define __AbstractElasticWaveEquation_CLASS_HEADER__
...
namespace ElasticWaveEquation3D{
  ...
  class AbstractElasticWaveEquation;
}

class ElasticWaveEquation3D::AbstractElasticWaveEquation: public exahype::solvers::ADERDGSolver, public exahype::solvers::UserADERDGSolverInterface {
  public:
    static constexpr int NumberOfVariables  = 9;
    static constexpr int NumberOfParameters = 16;
    static constexpr int Order              = 3;
    static constexpr double CFL             = 0.9;
    static constexpr int NumberOfPointSources = 4;
    ...
    AbstractElasticWaveEquation(double maximumMeshSize,int maximumAdaptiveMeshDepth,int DMPObservables,int limiterHelperLayers,exahype::solvers::Solver::TimeStepping timeStepping);
    ...
    void deltaDistribution(const double t,const double dt, const tarch::la::Vector<DIMENSIONS,double>& center,const tarch::la::Vector<DIMENSIONS,double>& dx, double** tempForceVector) override;
    void spaceTimePredictor(double* lQhbnd,double* lFhbnd,double** tempSpaceTimeUnknowns,double** tempSpaceTimeFluxUnknowns,double* tempUnknowns,double* tempFluxUnknowns, const double* const luh,const tarch::la::Vector<DIMENSIONS,double>& dx,const double dt, double** tempPointForceSources) override; 
...
#endif // __AbstractElasticWaveEquation_CLASS_HEADER__
