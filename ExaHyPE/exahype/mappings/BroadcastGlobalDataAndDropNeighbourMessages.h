...
#ifndef EXAHYPE_MAPPINGS_BroadcastGlobalDataAndDropNeighbourMessages_H_
#define EXAHYPE_MAPPINGS_BroadcastGlobalDataAndDropNeighbourMessages_H_
 ...
 */
class exahype::mappings::BroadcastGlobalDataAndDropNeighbourMessages {
private:
