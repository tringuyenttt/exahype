 ...
 */
peano::CommunicationSpecification   exahype::mappings::LocalRecomputation::communicationSpecification() const {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::LocalRecomputation::touchVertexLastTimeSpecification(int level) const {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::LocalRecomputation::touchVertexFirstTimeSpecification(int level) const { 
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::RunConcurrentlyOnFineGrid,true);
}
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::LocalRecomputation::enterCellSpecification(int level) const {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::LocalRecomputation::leaveCellSpecification(int level) const {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::AvoidFineGridRaces,true);
}
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::LocalRecomputation::ascendSpecification(int level) const {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::LocalRecomputation::descendSpecification(int level) const {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::AvoidCoarseGridRaces,true);
}


tarch::logging::Log                exahype::mappings::LocalRecomputation::_log( "exahype::mappings::LocalRecomputation" ); 


exahype::mappings::LocalRecomputation::LocalRecomputation() {
  logTraceIn( "LocalRecomputation()" );
  // @todo Insert your code here
  logTraceOut( "LocalRecomputation()" );
}
...
exahype::mappings::LocalRecomputation::LocalRecomputation(const LocalRecomputation&  masterThread) {
  logTraceIn( "LocalRecomputation(LocalRecomputation)" );
  // @todo Insert your code here
  logTraceOut( "LocalRecomputation(LocalRecomputation)" );
}


void exahype::mappings::LocalRecomputation::mergeWithWorkerThread(const LocalRecomputation& workerThread) {
  logTraceIn( "mergeWithWorkerThread(LocalRecomputation)" );
  // @todo Insert your code here
  logTraceOut( "mergeWithWorkerThread(LocalRecomputation)" );
}
#endif
