...
#ifndef EXAHYPE_ADAPTERS_MeshRefinementAndPlotGrid2VTKGridVisualiser_2_H_
#define EXAHYPE_ADAPTERS_MeshRefinementAndPlotGrid2VTKGridVisualiser_2_H_
...
namespace exahype {
      namespace adapters {
        class MeshRefinementAndPlotGrid2VTKGridVisualiser_2;
      } 
}
 ...
 */
class exahype::adapters::MeshRefinementAndPlotGrid2VTKGridVisualiser_2 {
  private:
    /**
  ...
  public:
    ...
    MeshRefinementAndPlotGrid2VTKGridVisualiser_2();

    #if defined(SharedMemoryParallelisation)
    MeshRefinementAndPlotGrid2VTKGridVisualiser_2(const MeshRefinementAndPlotGrid2VTKGridVisualiser_2& masterThread);
    #endif

    virtual ~MeshRefinementAndPlotGrid2VTKGridVisualiser_2();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const MeshRefinementAndPlotGrid2VTKGridVisualiser_2& workerThread);
    #endif
