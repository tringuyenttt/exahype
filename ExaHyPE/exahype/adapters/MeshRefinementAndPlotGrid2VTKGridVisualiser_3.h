...
#ifndef EXAHYPE_ADAPTERS_MeshRefinementAndPlotGrid2VTKGridVisualiser_3_H_
#define EXAHYPE_ADAPTERS_MeshRefinementAndPlotGrid2VTKGridVisualiser_3_H_
...
namespace exahype {
      namespace adapters {
        class MeshRefinementAndPlotGrid2VTKGridVisualiser_3;
      } 
}
 ...
 */
class exahype::adapters::MeshRefinementAndPlotGrid2VTKGridVisualiser_3 {
  private:
    /**
  ...
  public:
    ...
    MeshRefinementAndPlotGrid2VTKGridVisualiser_3();

    #if defined(SharedMemoryParallelisation)
    MeshRefinementAndPlotGrid2VTKGridVisualiser_3(const MeshRefinementAndPlotGrid2VTKGridVisualiser_3& masterThread);
    #endif

    virtual ~MeshRefinementAndPlotGrid2VTKGridVisualiser_3();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const MeshRefinementAndPlotGrid2VTKGridVisualiser_3& workerThread);
    #endif
