...
#ifndef EXAHYPE_ADAPTERS_MeshRefinement2MultiscaleLinkedCell_4_H_
#define EXAHYPE_ADAPTERS_MeshRefinement2MultiscaleLinkedCell_4_H_
...
namespace exahype {
      namespace adapters {
        class MeshRefinement2MultiscaleLinkedCell_4;
      } 
}
 ...
 */
class exahype::adapters::MeshRefinement2MultiscaleLinkedCell_4 {
  public:
    ...
    MeshRefinement2MultiscaleLinkedCell_4();

    #if defined(SharedMemoryParallelisation)
    MeshRefinement2MultiscaleLinkedCell_4(const MeshRefinement2MultiscaleLinkedCell_4& masterThread);
    #endif

    virtual ~MeshRefinement2MultiscaleLinkedCell_4();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const MeshRefinement2MultiscaleLinkedCell_4& workerThread);
    #endif
