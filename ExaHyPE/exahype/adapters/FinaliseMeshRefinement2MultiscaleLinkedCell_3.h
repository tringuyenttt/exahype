...
#ifndef EXAHYPE_ADAPTERS_FinaliseMeshRefinement2MultiscaleLinkedCell_3_H_
#define EXAHYPE_ADAPTERS_FinaliseMeshRefinement2MultiscaleLinkedCell_3_H_
...
namespace exahype {
      namespace adapters {
        class FinaliseMeshRefinement2MultiscaleLinkedCell_3;
      } 
}
 ...
 */
class exahype::adapters::FinaliseMeshRefinement2MultiscaleLinkedCell_3 {
  public:
    ...
    FinaliseMeshRefinement2MultiscaleLinkedCell_3();

    #if defined(SharedMemoryParallelisation)
    FinaliseMeshRefinement2MultiscaleLinkedCell_3(const FinaliseMeshRefinement2MultiscaleLinkedCell_3& masterThread);
    #endif

    virtual ~FinaliseMeshRefinement2MultiscaleLinkedCell_3();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const FinaliseMeshRefinement2MultiscaleLinkedCell_3& workerThread);
    #endif
